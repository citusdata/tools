...
def fetch_and_store_docker_statistics(repository_name: str, is_test: bool = False, test_day_shift_index: int = 0,
    ...
    db_engine = create_engine(db_connection_string(is_test=is_test))
...
if __name__ == "__main__":
    ...
    fetch_and_store_docker_statistics(arguments.repo_name, arguments.is_test, int(arguments.test_day_shift_index),
                                      int(arguments.test_pull_count_shift))
